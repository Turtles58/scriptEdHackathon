...
$(document).ready(function(){
    ...
    ["<p class = 'response'>To show you you are not alone</p>",7,"...",7,"How will that help?",7,"Thank you"],
    ...
    ["<p class = 'response'>Cutting was my only escape but it cost me my health ,if you cut too here is a number that will help,1-800-071-TALK</p>",13,"How did you stop?",13,"...",13,"thank you"],
